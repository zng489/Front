  ...
  update: function update(state) {
    ...
    function updateObj(obj, d) {
      ...
      var applyUpdate = function applyUpdate(td) {
        ...
        obj.geometry.setAttribute('surfaceRadius', array2BufferAttr(_toConsumableArray(new Array(obj.geometry.getAttribute('position').count)).map(function () {
